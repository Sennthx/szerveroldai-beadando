    ...
    <div class="max-w-xl mx-auto">
        <form method="POST" action="{{ route('animals.update', $animal->id) }}" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-4">
                ...
                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $animal->name)"
                    required autofocus />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="species" name="species" type="text" class="mt-1 block w-full" :value="old('species', $animal->species)"
                    required />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="born_at" name="born_at" type="date" class="mt-1 block w-full" :value="old('born_at', $animal->born_at->format('Y-m-d'))"
                    required />
